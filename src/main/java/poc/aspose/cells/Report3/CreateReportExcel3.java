package poc.aspose.cells.Report3;
 ...
 * 
 * création d'un histogramme dynamique à partir d'une table de données.
 *
 */
public class CreateReportExcel3 {
	public static void main(String[] args) throws Exception {

		// The path to the documents directory.
		String dataDir = Utils.getSharedDataDir(CreateReportExcel3.class) + "BP2S/";
		...
		// Save result on disc
		workbook.save(dataDir + "Report3.xlsx");
